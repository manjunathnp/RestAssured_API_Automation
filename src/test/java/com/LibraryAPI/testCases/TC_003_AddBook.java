...
public class TC_003_AddBook extends TestBase
{
	...
	{
		logger.info("********* Started TC_003_AddBook **********");
	...
	@Test(priority=3)
	void validateAddedBook_addBook() throws InterruptedException
	{
	
		logger.info("********* Added_Book_Validation **********");
	...
	@Test(priority=4)
	void checkResponseTime_addBook()
	{
	...
	void tearDown()
	{
		logger.info("*********  Finished TC_003_AddBook **********");
	}
